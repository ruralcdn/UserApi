					...
					<div id="gallery-wrapper">
						<div id="gallery"> 
							<div id="thumbnail-bg">
								...
								String Uploader=(String) session.getAttribute("uploader");
								String category=(String) session.getAttribute("category");
								String location=(String) session.getAttribute("location");
								//String choice = (String) session.getAttribute("choice");
								if(Subscription != null){%>															
								<th><h2><%=Subscription %></h2></th>								
								<% }else{%>
								<th><h2>Your Subscription is not Successful please try again </h2></th>
								<% }%>
								</table>
								<br>
								...
								<% if(Subscription != null){ %>
								<th><h3>Your Subscription Status</h3></th>
								<tr><td></td></tr>
								
								<tr><td align="center"><b>You are subscribed with user(user name) <font color="red"><b><%=Uploader %></b></font></font></b></td></tr>
								
								<tr><td></td></tr>
								
								<tr><td align="center"><b>You are subscribed with category(category name) <font color="red"><b><%=category %></b></font></font></b></td></tr>
								
								<tr><td></td></tr>
								
								<tr><td align="center"><b>You are subscribed with Location(Location name) <font color="red"><b><%=location %></b></font></font></b></td></tr>
