								 	...
								 	<table width="650" bgcolor="pink">
									 	<tr id="row1">
										 	<td align="center">										 										 	
											    ...
											    %>
											    <h3>
													<form name="form1" action ="AllCatListAdmin.jsp" method="post">
										 	...
										 	<td align="center">										 	
											    ...
											    %>
											    <h3>
											    	<form name="form2" action ="AllCatListAdmin.jsp" method="post">
										 	...
										 	<td align="center">											 	
											    ...
											    %>
											    <h3>
										    	<form name="form3" action ="AllCatListAdmin.jsp" method="post">
									 	...
									 	<tr id="row2">
										    ...
										    %>
										    <h3>
										    	<form name="form4" action ="AllCatListAdmin.jsp" method="post">
										    ...
										    <b><a href="UsertoCatSubsc?category=<%=category %>&follower=<%=username %>">Sub to this category</a></b>										    							 	
										 	...
										 	String QueryString4 = "SELECT dbvalue,count(*) from dbsync where dbkey like '%-cat' && dbvalue ='After Care of Plants('";
										   	...
										   	%>
										   	<h3>
										    	<form name="form5" action ="AllCatListAdmin.jsp" method="post">
											...
											%>
											<h3>
										 		<form name="form6" action ="AllCatListAdmin.jsp" method="post">
									 	...
									 	<tr id="row3">									 		
										    ...
										    %> 	  
										    <h3>
										 		<form name="form7" action ="AllCatListAdmin.jsp" method="post">
										    ...
										    %> 	  
										    <h3>
										 		<form name="form8" action ="AllCatListAdmin.jsp" method="post">
										    ...
										    %>
										    <h3>
										 		<form name="form9" action ="AllCatListAdmin.jsp" method="post">
									 	...
									 	<tr id="row4">									 		
										 	...
										 	String QueryString9 = "SELECT dbvalue,count(*) from dbsync where dbkey like '%-cat' && dbvalue ='Herbal Medicine'";
										   	...
										   	%>
										   	<h3>
										 		<form name="form10" action ="AllCatListAdmin.jsp" method="post">
										    ...
										    %> 	  
										    <h3>
										 		<form name="form11" action ="AllCatListAdmin.jsp" method="post">
										    ...
										    %> 	  
										    <h3>
										 		<form name="form12" action ="AllCatListAdmin.jsp" method="post">
									 	...
									 	<tr id="row5">								 		
										    ...
										    %>	  
										    <h3>
										 		<form name="form13" action ="AllCatListAdmin.jsp" method="post">
										    ...
										    %> 	  
											<h3>
										 		<form name="form14" action ="AllCatListAdmin.jsp" method="post">
										    ...
										    %> 	  
										     <h3>
										 		<form name="form15" action ="AllCatListAdmin.jsp" method="post">
									 	...
									 	<tr id="row6">								 		
										    ...
										    %> 	  
										     <h3>
										 		<form name="form16" action ="AllCatListAdmin.jsp" method="post">
										   ...
										   <b><a href="UsertoCatSubsc?category=<%=category %>&follower=<%=username %>">Sub to this category</a></b>										   
										    ...
										    %>
										 	<h3>
										 		<form name="form17" action ="AllCatListAdmin.jsp" method="post">
										    ...
										    %>
										 	<h3>
										 		<form name="form18" action ="AllCatListAdmin.jsp" method="post">
									 	...
									 	<tr id="row7">
										    ...
										    %>
										 	<h3>
										 		<form name="form19" action ="AllCatListAdmin.jsp" method="post">
										    ...
										    %>
										 	<h3>
										 		<form name="form20" action ="AllCatListAdmin.jsp" method="post">
										    ...
										    %>
										 	<h3>
										 		<form name="form21" action ="AllCatListAdmin.jsp" method="post">
