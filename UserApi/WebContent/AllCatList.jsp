						...
						<div id="gallery"> 
							<div id="thumbnail-bg">
								...
								<table width="650" bgcolor="#41A317">
									<th><font color="white" size="4px">Total Upload in <%=category %> Category</font></th>
								</table>
								<p>								
								<%
							      try {							          
										...
										String QueryString = "SELECT dbkey from dbsync where dbkey like '%-cat'";
										rs = statement.executeQuery(QueryString);
											...
											String QueryString = "SELECT dbkey from dbsync where dbkey like '%-cat' && dbvalue ='"+category+"'";
											rs = statement.executeQuery(QueryString);							          
												while(rs.next()){
													String temp = rs.getString(1);
													str.add(temp.substring(0,temp.indexOf("-")));													
							    ...
							    <%						    
									...
									String itemp = cid.substring(0,cid.lastIndexOf("."));
							    ...
							    <tr>
							        ...
							        <td>
							        	<form action="UsertoUserSubcription" method="post">
									        <input type="hidden" name="uploader" value="<%=title[3]%>"/>
									        <input type="hidden" name="follower" value="<%=username%>"/>							        
									        <input type="submit" value="Subs User"/>
									    </form>
							        </td>
							    </tr>
							<%}
