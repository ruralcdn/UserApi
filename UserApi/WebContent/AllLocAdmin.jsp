						...
						<div id="gallery"> 
							<div id="thumbnail-bg">
								...
								<table width="650" bgcolor="pink" align="center">
									...
									<%								   
									 String QueryString3 = "SELECT dbvalue,count(*) as c from dbsync where dbkey like '%-loc%' group by dbvalue order by c desc";
									...
									<tr>
										...
										<td align="center"><b><a href="VideosByLocAdmin.jsp?loc=<%=rs.getString(1) %>">See All Videos</a></b></td>
										<td align="center"><b><a href="UsertoLocSubsc?follower=<%=username %>&location=<%=rs.getString(1) %>">Subscribe to location</a></b></td>
									</tr>
									<%}%>																
								</table>
								<%						
