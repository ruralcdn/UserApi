					...
					<div id="gallery-wrapper">
						<div id="gallery"> 
							<div id="thumbnail-bg">
								...
								<th><h2>Your subscription has been remove</h2></th>								
								<% }else{%>
								<th><h2>Your subscription has been remove</h2></th>
								<% }%>
								</table>
								...
								<tr><td></td></tr>
								<%if(choice.equals("1")){ %>
								<tr><td align="center"><b>You are no longer subscribed with user(user name) <font color="red"><b><%=Uploader %></b></font></font></b></td></tr>
								<%} %>
								<tr><td></td></tr>
								<%if(choice.equals("2")){ %>
								<tr><td align="center"><b>You are no longer subscribed with category(category name) <font color="red"><b><%=category %></b></font></font></b></td></tr>
								<%} %>
								<tr><td></td></tr>
								<%if(choice.equals("3")){ %>
								<tr><td align="center"><b>You are no longer subscribed with Location(Location name) <font color="red"><b><%=location %></b></font></font></b></td></tr>
								<%} %>
								<%} %>
								</table>								
							</div>
