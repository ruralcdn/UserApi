...
username=(String) session.getAttribute("ulogname");
						...
						<div id="gallery"> 
							<div id="thumbnail-bg">
								...
								<table width="650" bgcolor="#41A317">
									<th><font color="white" size="4px" style="font-family:fantasy;">Select File For Upload</font></th>
								</table>
								<br>
								
								<!-- upload function call -->
								
								<form name="form1" method="post" action="UploadFile" name="onlineform1" onSubmit="return validateform1(this.form)">
									<table align="center" width="650" bgcolor="pink" height="412">
																		
									<tr>
										<td align="center" width="300"><b>Video File</b></td>
										<td align="left"><input type="file" name="filename"/></td>
									</tr>
									<tr><td></td></tr>									
									<tr>
										<td align="center"><b>File Title</b></td>
										<td align="left"><input type="text" name="title"/></td>
									</tr>
									<tr><td></td></tr>
									<tr>
										<td align="center"><b>Video's Language</b></td>
										<td align="left">
									...
									<tr><td></td></tr>									
									<tr>
										<td align="center"><b>Video's Category</b></td>
										<td align="left">
											<select name="cat">
												<option>------------Select Video Category------------</option>											
												<option>Animal Care</option>
												<option>Application of Insecticide & Fungicide</option>
												...
												<option>Soil Sample Collection for Soil Testing</option>
									...
									<tr><td></td></tr>
									<tr>
										<td align="center"><b>Choose Upload Method</b></td>
										<td align="left">
											<select name="choice">
												<option>----Select----</option>
												<option value="1">Upload By Internet</option>
												<option value="2">Upload By USb</option>
											</select>
										</td>
									</tr>
