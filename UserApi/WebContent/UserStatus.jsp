						...
						<div id="gallery"> 
							<div id="thumbnail-bg">
								...
								<table width="650" bgcolor="#41A317">
									<th><font color="white" size="4px">File Uploaded By you</font></th>
								</table>
								<p>								
								<%
							      try {							          
							          ...
							          String QueryString = "SELECT dbkey from dbsync where dbvalue ='"+username+"'";
								...
								%>
								<TABLE border="0" style="background-color: pink;" align="center" width="650">
								<tr>
								<td><h4></h4></td>
								<td><h4>Title</h4></td>
							    ...
							    <%
									for(int i =0; i < str.size(); i++) {									 
										...
										while(rs1.next()){
											...
											filetemp = rs1.getString(1);
										}
										fileid = filetemp.substring(0,filetemp.indexOf("-"));
							    ...
							    <tr>
							        ...
							        <td>
							        	<form action = "FileDelete" method="post">
							        		...
							        		<input type="submit" value="Delete From The Record"/>
							        	</form>
							        </td>
							    </tr>
							    <% rs1.close();}						  							    
									...
									System.out.println("Exception occurs in UserStatus.java");
									ex.printStackTrace();						                
									}
								%>
							    </TABLE>
